...
export default class Index extends Component {
    ...
    render() {
        ...
        const rotateBox = arr.map((e, i) => (
            <View
                className="sector"
                style={`transform: rotate(${i * (360 / l)}deg)`}
            >
                <View
                    class="sector-inner"
                    style={`transform: translatex(-250rpx) rotate(${360 /
                        l}deg)`}
                >
                    <span
                        style={`transform: translate(0, -100%) rotate(-${360 /
                            arr.length /
                            2}deg); width: ${Math.sin(
        ...
        return (
            <View className="rotate-game">
                ...
                <View className="rotate-box">
                    <View
                        style={`transform: translate(-50%, 0) rotate(${this.state.num}deg);`}
